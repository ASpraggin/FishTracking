...
\begin{figure}[H]
	...
	\includegraphics[height=\mylen]{img1}
	\hspace{.02\linewidth}
	\includegraphics[height=\mylen]{overlap}
	\caption{Left: A basic swap check, longer(wrong) distances are in pen. Right: An example of an Overlap}
