...
%talk about idTracker.ai, trex(trex.run)(doesn't work as well). both use machine learning. deeplabcut (more for posture tracking, also uses machine learning, need to identify points(training).) lot of activity in area due to machine learning, but machine learning is much more intensive computationally, and in house solution is more tailored to what groups are doing.

\section{Results}

\subsection{Introduction}
%better heading, need experimental heading subheader, say experiment not part of project, but need to cover for completeness.
